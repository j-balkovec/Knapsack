/**
 * @file HeavyGreedy.cpp
 * 
 * @author Jakob Balkovec
 * @date 2024-12-12
 * @brief The Heavy Greedy heuristic for the Knapsack problem.
...
/**
 * Calculates the maximum value that can be obtained by selecting items for a knapsack using the Heavy Greedy algorithm.
 * 
